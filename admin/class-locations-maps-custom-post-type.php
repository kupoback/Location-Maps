...
class Locations_Maps_Custom_Post_Type
{
	...
	public function custom_post_type_locations() {
		...
		$labels = array(
			...
			'all_items'             => __( 'All Properties', 'locations-maps' ),
			...
			'insert_into_item'      => __( 'Insert into location', 'locations-maps' ),
			...
			'filter_items_list'     => __( 'Filter Locationlist', 'locations-maps' ),
		);
		$args = array(
